...
<body>
    ...
    <div class="index-content"><!--phần nội dung-->
        <div class="sp-ban-chay">
           <div class="link"><a>Trang chủ</a> / <p style="text-transform: capitalize;display: inline;"></p><?php print_r ($categori[0]['name']);?></p> </div>
           <p class="product-title"></p>
            <div class="row">
                
            @foreach($product as $pro)
                <div class="col-lg-3">
                    <a href="#"><img src="fontend/img/{{$pro->images}}"></a>
